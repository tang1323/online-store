          ...
          <div class="address">
            ...
            <ul>
              ...
              <li v-for="item in addrInfo" :class="{'addressActive':addressActive==item.id}" @click="selectAddr(item.id)">
                ...
                <p class="item">电话：{{item.singer_mobile}}</p>
                <p class="item">姓名：{{item.singer_name}}</p>
              </li>
            </ul>
          </div>
          <div class="pay">
      ...
      selectAddr (id) { //选择配送地址
        ...
        this.addrInfo.forEach(function(addrItem) {
          if(addrItem.id == id){
            ...
            cur_name = addrItem.singer_name
            cur_mobile = addrItem.singer_mobile
          }
        });
        this.address = cur_address
        this.singer_mobile = cur_mobile
        this.singer_name = cur_name
      },
      balanceCount () { // 结算
            ...
            createOrder(
              {
                ...
                singer_mobile:this.singer_mobile,
