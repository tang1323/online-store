                    ...
                    <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
                        ...
                        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd" v-for="(item, index) in receiveInfoArr">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="left" bgcolor="#ffffff"><input name="consignee" type="text" class="inputBg" id="consignee_0" value="ssss" v-model="item.singer_name">
                                        <span :class = "{error:item.singer_name==''}">(必填)</span>
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td align="left" bgcolor="#ffffff"><input name="mobile" type="text" class="inputBg" id="mobile_0" v-model="item.singer_mobile"><span :class = "{error:item.singer_mobile==''}">(必填)</span></td>
                                </tr>
                                <tr>
                        ...
                        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                            <tbody>
                                ...
                                <tr>
                                    <td align="right" bgcolor="#ffffff">收货人姓名：</td>
                                    <td align="left" bgcolor="#ffffff"><input name="consignee" type="text" class="inputBg" id="consignee_0" value="ssss" v-model="newInfo.singer_name">
                                        <span :class = "{error:newInfo.singer_name==''}">(必填)</span> </td>
                                ...
                                <tr>
                                    ...
                                    <td align="right" bgcolor="#ffffff">手机：</td>
                                    <td align="left" bgcolor="#ffffff"><input name="mobile" type="text" class="inputBg" id="mobile_0" v-model="newInfo.singer_mobile"><span :class = "{error:newInfo.singer_mobile==''}">(必填)</span></td>
                                </tr>
                                <tr>
                                    <td align="right" bgcolor="#ffffff">&nbsp;</td>
                                    <td colspan="3" align="center" bgcolor="#ffffff">
