  ...
  <div id="header" class="new_header">
    ...
    <div class="hd_main cle">
        ...
        <div class="head_search_hot">
         <span>热搜榜：</span>
<!--          这是搜索框的。与在85行的不一样，那是标题栏的的路径-->
<!--          '/app/home/search/'是vue的router的路径，不是后端的url
              更进一步的跳转是在router文件下的index.js-->
            ...
            <div class="main_nav main_nav_hover" id="main_nav">
                <div class="main_nav_link" @mouseover="overAllmenu" @mouseout="outAllmenu">
                    ...
                    <div class="main_cata" id="J_mainCata" v-show="showAllmenu">
                        <ul>
<!--                            mouseover和mouseout就是我们鼠标放上去的效果，自动有数据出来-->
<!--                            这里在223行拿到数据，我们就用vue的for循环进行一个遍历，-->
...
<!--                               这是标题栏的。与在44行的不一样，那是搜索search的路径
                                  '/app/home/list/'是vue的router的路径，不是后端的url
                                  更进一步的跳转是在router文件下的index.js-->
            ...
            <ul class="sub_nav cle" id="sub_nav">
                <li>
<!--                  前端的标题栏有没有一级分类需要到后台管理系统做一个“是否导航”才能显示-->
<!--                  在这里就是用is_tab做一个判断，这样在前端页面显示出来了
                       在models里也有一个叫is_tab的，跟这里一致-->
